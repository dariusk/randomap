...
document.title = nouns.nouns.pick() + ' per ' + nouns.nouns.pick();

var colorScheme = ["Blues" , "Purples", "OrRd", "YlOrRd", "Greens", "Reds", "PuOr", "BrBG", "PRGn"].pick();
...
var counties = map.append("svg:g")
    .attr("id", "counties")
    .attr("class", colorScheme) // NB: Change color scheme here
...
var legend = svg.append("svg:g")
    .attr("id", "legend")
    .attr("class", colorScheme); // NB: Change the color scheme here
